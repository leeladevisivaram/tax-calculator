export const REQUIRED_UI_ELEMENTS = [
  ...
  { selector: "#chatbot-toggle-button", label: "Chatbot toggle button", type: "button" },
  { selector: "#chatbot-panel", label: "Chatbot panel", type: "shell" },
  { selector: "#chatbot-close-button", label: "Chatbot close button", type: "button" },
  { selector: "#chatbot-messages", label: "Chatbot messages region", type: "output" },
  { selector: "#chatbot-ai-status", label: "Chatbot AI status", type: "output" },
  { selector: "#chatbot-form", label: "Chatbot form", type: "shell" },
  { selector: "#chatbot-input", label: "Chatbot input", type: "shell" },
  { selector: "#chatbot-send-button", label: "Chatbot send button", type: "button" },
  { selector: "#chatbot-action-preview", label: "Chatbot action preview", type: "output" },
